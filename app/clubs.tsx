/**
 * Clubs Landing Page
 * Placeholder page for club features
 */
      ...
      >
        <View style={[styles.content, isDesktop && styles.contentDesktop]}>
          ...
          <Text style={[styles.subtitle, isDesktop && styles.subtitleDesktop]}>
            We're building comprehensive regatta management tools to help your club organize races, manage entries, and publish results seamlessly.
          </Text>
          ...
          <View style={styles.featuresList}>
            ...
            <View style={styles.featureItem}>
              <Ionicons name="checkmark-circle" size={20} color="#FFFFFF" />
              <Text style={styles.featureText}>Entry management system</Text>
            </View>
            <View style={styles.featureItem}>
              <Ionicons name="checkmark-circle" size={20} color="#FFFFFF" />
