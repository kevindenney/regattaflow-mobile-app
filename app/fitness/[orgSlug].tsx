...
/** Legacy route — redirects to health-and-fitness */
export default function FitnessOrgPage() {
  ...
  return (
    <Container style={containerStyle}>
      <OrganizationBrowserPage interestSlug="health-and-fitness" orgSlug={orgSlug!} />
    </Container>
  );
}
