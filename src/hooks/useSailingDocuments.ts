...
import { sailingDocumentLibrary } from '@/src/services/storage/SailingDocumentLibraryService';
import type { SailingDocument } from '@/src/services/storage/SailingDocumentLibraryService';
...
export const uploadTidesCurrentStrategyBook = async (
  ...
  const documentLibrary = new (await import('@/src/services/storage/SailingDocumentLibraryService')).SailingDocumentLibraryService();
