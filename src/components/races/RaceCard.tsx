...
import { Clock, MapPin, Wind, Waves, Radio } from 'lucide-react-native';
import { useRouter } from 'expo-router';
import { calculateCountdown } from '@/src/constants/mockData';
...
export function RaceCard({
  ...
  const handlePress = () => {
    // Navigate to race detail page (works for both mock and real races)
        ...
        <View style={styles.environmentalCard}>
          <View style={styles.detailRowEnhanced}>
            ...
            <View style={styles.detailContent}>
              ...
              <Text style={styles.detailValueLarge}>
                {tide.state} {tide.height}m {tide.direction ? `→ ${tide.direction}` : ''}
              </Text>
            </View>
          </View>
        </View>
