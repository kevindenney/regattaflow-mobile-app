...
import { useSailingEducation, useVenueSailingEducation } from '@/src/hooks/useSailingEducation';
import type { EnhancedEducationalStrategy } from '@/src/hooks/useSailingEducation';
