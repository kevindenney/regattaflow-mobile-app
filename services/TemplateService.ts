...
class TemplateService {
  ...
  async copyRaceWithPreparation(
    ...
    try {
      // Step 1: Get full source race data
      ...
      if (sourceError || !sourceRace) {
        ...
        return { success: false, error: 'Source race not found' };
      }
      ...
      const newRaceData = {
        ...
        id: undefined,
        created_by: userId,
        content_visibility: 'private', // Reset to private for copied races
        metadata: {
          ...sourceRace.metadata,
      ...
      delete newRaceData.id;
      delete newRaceData.created_at;
      delete newRaceData.updated_at;
      // Remove non-existent columns that might cause errors
      delete newRaceData.source_regatta_id;
      delete newRaceData.is_copy;
      ...
      // Step 3: Copy preparation data if exists
      if (preparation) {
        try {
          const newPreparation: SailorRacePreparation = {
            ...
            // Copy intentions but clear checklist completions
