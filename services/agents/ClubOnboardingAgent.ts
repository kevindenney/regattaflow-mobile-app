...
This is typically the FIRST tool to call.`,
      ...
      execute: async (input) => {
        console.log('🔧 Tool: detect_venue_and_analyze_operations', input);
        ...
        try {
          ...
          console.error('❌ Tool failed: detect_venue_and_analyze_operations', error);
          return {
            success: false,
...
Returns club classification, subscription tier recommendation, and data-driven setup suggestions.`,
      ...
      execute: async (input) => {
        console.log('🔧 Tool: analyze_club_type_and_recommend_setup', input);
        ...
        try {
          ...
          console.error('❌ Tool failed: analyze_club_type_and_recommend_setup', error);
          return {
            success: false,
...
Returns Notice of Race and Sailing Instructions ready for review.`,
      ...
      execute: async (input) => {
        console.log('🔧 Tool: generate_race_documents_from_templates', input);
...
Generated by RegattaFlow`;
          ...
          console.error('❌ Tool failed: generate_race_documents_from_templates', error);
          return {
            success: false,
...
Returns intelligence status and configured API sources.`,
      ...
      execute: async (input) => {
        console.log('🔧 Tool: discover_and_import_venue_intelligence', input);
        ...
        try {
          ...
          console.error('❌ Tool failed: discover_and_import_venue_intelligence', error);
          return {
            success: false,
...
Returns regional benchmarks and recommended fee structure.`,
      ...
      execute: async (input) => {
        console.log('🔧 Tool: benchmark_and_optimize_pricing', input);
        ...
        try {
          ...
          console.error('❌ Tool failed: benchmark_and_optimize_pricing', error);
          return {
            success: false,
...
Returns venue network configuration and unified systems setup.`,
      ...
      execute: async (input) => {
        console.log('🔧 Tool: configure_multi_venue_operations', input);
        ...
        try {
          ...
          console.error('❌ Tool failed: configure_multi_venue_operations', error);
          return {
            success: false,
...
Returns recommended roles and invitation status.`,
      ...
      execute: async (input) => {
        console.log('🔧 Tool: setup_staff_and_permissions_intelligently', input);
        ...
        try {
          ...
          console.error('❌ Tool failed: setup_staff_and_permissions_intelligently', error);
          return {
            success: false,
...
Returns setup summary, next steps, and celebration message.`,
      ...
      execute: async (input) => {
        console.log('🔧 Tool: finalize_club_onboarding_with_celebration', input);
...
Welcome to the future of race management!`;
          ...
          console.error('❌ Tool failed: finalize_club_onboarding_with_celebration', error);
          return {
            success: false,
