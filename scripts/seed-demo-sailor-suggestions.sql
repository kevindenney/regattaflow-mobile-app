...
BEGIN
    ...
    IF sfyc_id IS NULL THEN
        INSERT INTO clubs (name, short_name, location, website)
        VALUES ('San Francisco Yacht Club', 'SFYC', 'San Francisco, CA', 'https://sfyc.org')
    ...
    IF hkryc_id IS NULL THEN
        INSERT INTO clubs (name, short_name, location, website)
        VALUES ('Hong Kong Royal Yacht Club', 'HKRYC', 'Hong Kong', 'https://rhkyc.org.hk')
