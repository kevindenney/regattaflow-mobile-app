...
-- 147+ Major Sailing Destinations Worldwide (SYNTAX FIXED)
-- Execute this in Supabase SQL Editor

-- PART 1: Additional venues beyond the initial 12 (which are already deployed)
INSERT INTO sailing_venues (id, name, coordinates_lat, coordinates_lng, country, region, venue_type, time_zone, data_quality)
VALUES
  -- World Sailing Championship Venues 2024-2026
  ...
  ('marthas-vineyard', 'Marthas Vineyard', 41.3888, -70.6394, 'United States', 'north-america', 'premier', 'America/New_York', 'verified'),
  ...
  ('marstrand-sweden', 'Marstrand - Bohuslan', 57.8861, 11.5917, 'Sweden', 'europe', 'regional', 'Europe/Stockholm', 'verified'),
  ...
  ('copenhagen-oresund', 'Copenhagen - Oresund', 55.6761, 12.5683, 'Denmark', 'europe', 'regional', 'Europe/Copenhagen', 'verified'),
  ...
  ('aland-islands', 'Aland Islands', 60.1785, 19.9156, 'Finland', 'europe', 'regional', 'Europe/Helsinki', 'verified'),
  ...
  ('klaipeda-lithuania', 'Klaipeda - Lithuania', 55.7033, 21.1443, 'Lithuania', 'europe', 'regional', 'Europe/Vilnius', 'verified'),
  ...
  ('cadiz-spain', 'Cadiz - Atlantic Coast', 36.5270, -6.2885, 'Spain', 'europe', 'regional', 'Europe/Madrid', 'verified'),
  ...
  ('antibes-france', 'Antibes - Cote d Azur', 43.5804, 7.1250, 'France', 'europe', 'premier', 'Europe/Paris', 'verified'),
  ...
  ('guadeloupe-pointe-a-pitre', 'Pointe-a-Pitre - Guadeloupe', 16.2333, -61.5333, 'Guadeloupe', 'caribbean', 'regional', 'America/Guadeloupe', 'verified'),
  ...
  ('curacao-willemstad', 'Willemstad - Curacao', 12.1191, -68.9334, 'Curacao', 'caribbean', 'regional', 'America/Curacao', 'verified'),
  ...
  ('noumea-new-caledonia', 'Noumea - New Caledonia', -22.2758, 166.4581, 'New Caledonia', 'oceania', 'regional', 'Pacific/Noumea', 'verified'),
...
-- Additional yacht clubs for major venues
...
VALUES
  ...
  ('royal-gothenburg-yacht-club', 'gothenburg-sweden', 'Kungliga Goteborgs Segelsallskap', 'KGSS', 'national', 'private'),
  ('royal-norwegian-yacht-club', 'oslo-fjord', 'Kongelig Norsk Seilforening', 'KNS', 'national', 'private'),
  ('club-nautico-ibiza', 'ibiza-balearic', 'Club Nautico de Ibiza', 'CNI', 'regional', 'private'),
  ...
  ('club-nautico-san-juan', 'puerto-rico-san-juan', 'Club Nautico de San Juan', 'CNSJ', 'regional', 'private'),
  ('nassau-yacht-club', 'bahamas-nassau', 'Nassau Yacht Club', 'NYC', 'regional', 'private')

ON CONFLICT (id) DO NOTHING;

-- Final summary
SELECT 'RegattaFlow Global Venue Intelligence: 147+ VENUES DEPLOYED SUCCESSFULLY!' as result;
SELECT
