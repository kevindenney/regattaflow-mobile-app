...
export function createUpcomingDemoRace(): DemoRace {
  ...
  return {
    ...
    metadata: {
      ...
      route_waypoints: [
        { name: 'Start/Finish Line', lat: 50.7710, lng: -1.2986, order: 1 },
        { name: 'Windward Mark', lat: 50.7820, lng: -1.3100, order: 2 },
        { name: 'Leeward Gate (Port)', lat: 50.7700, lng: -1.2800, order: 3 },
        { name: 'Leeward Gate (Starboard)', lat: 50.7700, lng: -1.2760, order: 4 },
      ],
      prohibited_areas: [
...
export function createPastDemoRace(): DemoRace {
  ...
  return {
    ...
    metadata: {
      ...
      route_waypoints: [
        { name: 'Start Line', lat: 50.7660, lng: -1.2986, order: 1 },
        ...
        { name: 'Finish Line', lat: 50.7660, lng: -1.2986, order: 7 },
      ],
      race_documents: [
        { type: 'NOR', name: 'Notice of Race', url: '#demo-nor' },
        { type: 'SI', name: 'Sailing Instructions', url: '#demo-si' },
