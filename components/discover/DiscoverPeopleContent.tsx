/**
 * DiscoverPeopleContent — People segment for the Discover tab
 *
 * Adapted from components/connect/FollowContent.tsx.
 * Shows people to follow based on current interest.
 */
...
import { DemoPeerCard, DemoPostCard } from '@/components/connect/DemoCards';
