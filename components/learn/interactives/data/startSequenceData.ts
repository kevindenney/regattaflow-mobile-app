...
export const RACING_SEQUENCE_STEPS: SequenceStep[] = [
  ...
  // ==================== ONE MINUTE SIGNAL (1:00) ====================
  {
    ...
    description: 'One minute to start! P flag remains up.',
    details: [
      'One long horn sound',
      'Boats should be in position for final approach',
      'Final chance to check line bias',
  ...
  { time: -58, label: '', visualState: { orange: 'UP', class: 'UP', p: 'UP' }, soundSignal: '', description: '', action: 'MOVE', blueStart: { x: 448, y: 313, rotate: 90 }, redStart: { x: 552, y: 300, rotate: 90 } },
  { time: -56, label: '', visualState: { orange: 'UP', class: 'UP', p: 'UP' }, soundSignal: '', description: '', action: 'MOVE', blueStart: { x: 456, y: 312, rotate: 90 }, redStart: { x: 558, y: 299, rotate: 90 } },
  { time: -54, label: '', visualState: { orange: 'UP', class: 'UP', p: 'UP' }, soundSignal: '', description: '', action: 'MOVE', blueStart: { x: 462, y: 311, rotate: 90 }, redStart: { x: 564, y: 298, rotate: 90 } },
  { time: -52, label: '', visualState: { orange: 'UP', class: 'UP', p: 'UP' }, soundSignal: '', description: '', action: 'MOVE', blueStart: { x: 468, y: 310, rotate: 90 }, redStart: { x: 570, y: 297, rotate: 90 } },
  { time: -50, label: 'Final Setup', visualState: { orange: 'UP', class: 'UP', p: 'UP' }, soundSignal: '', description: '50 seconds. Maintaining course.', action: 'MOVE', blueStart: { x: 475, y: 309, rotate: 90 }, redStart: { x: 576, y: 296, rotate: 90 } },
  { time: -48, label: '', visualState: { orange: 'UP', class: 'UP', p: 'UP' }, soundSignal: '', description: '', action: 'MOVE', blueStart: { x: 480, y: 308, rotate: 90 }, redStart: { x: 580, y: 295, rotate: 90 } },
  { time: -46, label: '', visualState: { orange: 'UP', class: 'UP', p: 'UP' }, soundSignal: '', description: '', action: 'MOVE', blueStart: { x: 485, y: 307, rotate: 90 }, redStart: { x: 582, y: 294, rotate: 90 } },
  { time: -44, label: '', visualState: { orange: 'UP', class: 'UP', p: 'UP' }, soundSignal: '', description: '', action: 'MOVE', blueStart: { x: 490, y: 306, rotate: 90 }, redStart: { x: 584, y: 293, rotate: 90 } },
  { time: -42, label: '', visualState: { orange: 'UP', class: 'UP', p: 'UP' }, soundSignal: '', description: '', action: 'MOVE', blueStart: { x: 494, y: 305, rotate: 90 }, redStart: { x: 586, y: 292, rotate: 90 } },
  { time: -40, label: 'Final Setup', visualState: { orange: 'UP', class: 'UP', p: 'UP' }, soundSignal: '', description: '40 seconds. Setting up for the turn.', action: 'MOVE', blueStart: { x: 498, y: 304, rotate: 90 }, redStart: { x: 588, y: 291, rotate: 90 } },
  { time: -38, label: '', visualState: { orange: 'UP', class: 'UP', p: 'UP' }, soundSignal: '', description: '', action: 'MOVE', blueStart: { x: 500, y: 302, rotate: 90 }, redStart: { x: 590, y: 290, rotate: 90 } },
  { time: -36, label: '', visualState: { orange: 'UP', class: 'UP', p: 'UP' }, soundSignal: '', description: '', action: 'MOVE', blueStart: { x: 502, y: 300, rotate: 90 }, redStart: { x: 590, y: 288, rotate: 90 } },
  { time: -34, label: '', visualState: { orange: 'UP', class: 'UP', p: 'UP' }, soundSignal: '', description: '', action: 'MOVE', blueStart: { x: 502, y: 298, rotate: 60 }, redStart: { x: 590, y: 286, rotate: 60 } },
  { time: -32, label: '', visualState: { orange: 'UP', class: 'UP', p: 'UP' }, soundSignal: '', description: '32 seconds. Beginning to turn!', action: 'MOVE', blueStart: { x: 500, y: 295, rotate: 30 }, redStart: { x: 588, y: 283, rotate: 30 } },
  ...
  { time: -29, label: '', visualState: { orange: 'UP', class: 'UP', p: 'UP' }, soundSignal: '', description: '', action: 'MOVE', blueStart: { x: 488, y: 356, rotate: 315 }, redStart: { x: 576, y: 354, rotate: 315 } },
  { time: -28, label: '', visualState: { orange: 'UP', class: 'UP', p: 'UP' }, soundSignal: '', description: '', action: 'MOVE', blueStart: { x: 481, y: 352, rotate: 315 }, redStart: { x: 570, y: 350, rotate: 315 } },
  { time: -27, label: '', visualState: { orange: 'UP', class: 'UP', p: 'UP' }, soundSignal: '', description: '', action: 'MOVE', blueStart: { x: 474, y: 348, rotate: 315 }, redStart: { x: 564, y: 346, rotate: 315 } },
  { time: -26, label: '', visualState: { orange: 'UP', class: 'UP', p: 'UP' }, soundSignal: '', description: '', action: 'MOVE', blueStart: { x: 467, y: 344, rotate: 315 }, redStart: { x: 558, y: 342, rotate: 315 } },
  { time: -25, label: '', visualState: { orange: 'UP', class: 'UP', p: 'UP' }, soundSignal: '', description: '', action: 'MOVE', blueStart: { x: 460, y: 340, rotate: 315 }, redStart: { x: 552, y: 338, rotate: 315 } },
  { time: -24, label: '', visualState: { orange: 'UP', class: 'UP', p: 'UP' }, soundSignal: '', description: '', action: 'MOVE', blueStart: { x: 453, y: 336, rotate: 315 }, redStart: { x: 546, y: 334, rotate: 315 } },
  { time: -23, label: '', visualState: { orange: 'UP', class: 'UP', p: 'UP' }, soundSignal: '', description: '', action: 'MOVE', blueStart: { x: 446, y: 332, rotate: 315 }, redStart: { x: 540, y: 330, rotate: 315 } },
  { time: -22, label: '', visualState: { orange: 'UP', class: 'UP', p: 'UP' }, soundSignal: '', description: '', action: 'MOVE', blueStart: { x: 439, y: 328, rotate: 315 }, redStart: { x: 534, y: 326, rotate: 315 } },
  { time: -21, label: '', visualState: { orange: 'UP', class: 'UP', p: 'UP' }, soundSignal: '', description: '', action: 'MOVE', blueStart: { x: 432, y: 324, rotate: 315 }, redStart: { x: 528, y: 322, rotate: 315 } },
  { time: -20, label: 'Final Approach', visualState: { orange: 'UP', class: 'UP', p: 'UP' }, soundSignal: '', description: '20 seconds! Building speed toward the line.', action: 'MOVE', blueStart: { x: 425, y: 320, rotate: 315 }, redStart: { x: 522, y: 318, rotate: 315 } },
  { time: -19, label: '', visualState: { orange: 'UP', class: 'UP', p: 'UP' }, soundSignal: '', description: '', action: 'MOVE', blueStart: { x: 418, y: 316, rotate: 315 }, redStart: { x: 516, y: 314, rotate: 315 } },
  { time: -18, label: '', visualState: { orange: 'UP', class: 'UP', p: 'UP' }, soundSignal: '', description: '', action: 'MOVE', blueStart: { x: 411, y: 312, rotate: 315 }, redStart: { x: 510, y: 310, rotate: 315 } },
  { time: -17, label: '', visualState: { orange: 'UP', class: 'UP', p: 'UP' }, soundSignal: '', description: '', action: 'MOVE', blueStart: { x: 404, y: 308, rotate: 315 }, redStart: { x: 504, y: 306, rotate: 315 } },
  { time: -16, label: '', visualState: { orange: 'UP', class: 'UP', p: 'UP' }, soundSignal: '', description: '', action: 'MOVE', blueStart: { x: 397, y: 304, rotate: 315 }, redStart: { x: 498, y: 302, rotate: 315 } },
  { time: -15, label: '', visualState: { orange: 'UP', class: 'UP', p: 'UP' }, soundSignal: '', description: '', action: 'MOVE', blueStart: { x: 390, y: 300, rotate: 315 }, redStart: { x: 492, y: 298, rotate: 315 } },
  { time: -14, label: '', visualState: { orange: 'UP', class: 'UP', p: 'UP' }, soundSignal: '', description: '', action: 'MOVE', blueStart: { x: 383, y: 296, rotate: 315 }, redStart: { x: 490, y: 294, rotate: 315 } },
  { time: -13, label: '', visualState: { orange: 'UP', class: 'UP', p: 'UP' }, soundSignal: '', description: '', action: 'MOVE', blueStart: { x: 376, y: 292, rotate: 315 }, redStart: { x: 488, y: 290, rotate: 315 } },
  { time: -12, label: '', visualState: { orange: 'UP', class: 'UP', p: 'UP' }, soundSignal: '', description: '', action: 'MOVE', blueStart: { x: 369, y: 288, rotate: 315 }, redStart: { x: 486, y: 286, rotate: 315 } },
  { time: -11, label: '', visualState: { orange: 'UP', class: 'UP', p: 'UP' }, soundSignal: '', description: '', action: 'MOVE', blueStart: { x: 362, y: 284, rotate: 315 }, redStart: { x: 484, y: 282, rotate: 315 } },
  // At -10 seconds, boats are approaching - centers well south of line
  { time: -10, label: 'Final Approach', visualState: { orange: 'UP', class: 'UP', p: 'UP' }, soundSignal: '', description: '10 seconds! Full speed toward the line!', action: 'MOVE', blueStart: { x: 360, y: 280, rotate: 315 }, redStart: { x: 500, y: 278, rotate: 315 } },
  { time: -9, label: '', visualState: { orange: 'UP', class: 'UP', p: 'UP' }, soundSignal: '', description: '', action: 'MOVE', blueStart: { x: 355, y: 274, rotate: 315 }, redStart: { x: 496, y: 272, rotate: 315 } },
  { time: -8, label: '', visualState: { orange: 'UP', class: 'UP', p: 'UP' }, soundSignal: '', description: '', action: 'MOVE', blueStart: { x: 350, y: 268, rotate: 315 }, redStart: { x: 492, y: 266, rotate: 315 } },
  { time: -7, label: '', visualState: { orange: 'UP', class: 'UP', p: 'UP' }, soundSignal: '', description: '', action: 'MOVE', blueStart: { x: 345, y: 262, rotate: 315 }, redStart: { x: 488, y: 260, rotate: 315 } },
  { time: -6, label: '', visualState: { orange: 'UP', class: 'UP', p: 'UP' }, soundSignal: '', description: '', action: 'MOVE', blueStart: { x: 340, y: 256, rotate: 315 }, redStart: { x: 485, y: 254, rotate: 315 } },
  // At -5 seconds, boat CENTERS are at y=250, bows extend ~25px NW to ~y=225 (well south of line at y=200)
  { time: -5, label: 'Final Approach', visualState: { orange: 'UP', class: 'UP', p: 'UP' }, soundSignal: '', description: '5 seconds! Bows just below the line!', action: 'MOVE', blueStart: { x: 335, y: 250, rotate: 315 }, redStart: { x: 482, y: 248, rotate: 315 } },
  { time: -4, label: '', visualState: { orange: 'UP', class: 'UP', p: 'UP' }, soundSignal: '', description: '', action: 'MOVE', blueStart: { x: 330, y: 244, rotate: 315 }, redStart: { x: 480, y: 242, rotate: 315 } },
  { time: -3, label: '', visualState: { orange: 'UP', class: 'UP', p: 'UP' }, soundSignal: '', description: '', action: 'MOVE', blueStart: { x: 325, y: 238, rotate: 315 }, redStart: { x: 478, y: 236, rotate: 315 } },
  { time: -2, label: '', visualState: { orange: 'UP', class: 'UP', p: 'UP' }, soundSignal: '', description: '', action: 'MOVE', blueStart: { x: 320, y: 232, rotate: 315 }, redStart: { x: 476, y: 230, rotate: 315 } },
  { time: -1, label: '', visualState: { orange: 'UP', class: 'UP', p: 'UP' }, soundSignal: '', description: '', action: 'MOVE', blueStart: { x: 315, y: 228, rotate: 315 }, redStart: { x: 474, y: 226, rotate: 315 } },
  // ==================== START SIGNAL (0:00) ====================
...
export const STARTING_SEQUENCE_QUIZ = [
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'b', text: 'Class flag and P flag are dropped', isCorrect: true },
