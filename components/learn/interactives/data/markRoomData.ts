...
// All windward mark scenarios: boats approach on STARBOARD TACK from the RIGHT side
// Wind is from North (0 degrees), boats sail close-hauled toward the mark
export const PRACTICE_SCENARIOS: MarkRoomScenario[] = [
  // Scenario 1: You are inside boat, overlapped at zone - entitled to room
  // Boats approach from bottom-right, sailing NW toward mark on starboard tack
  {
    id: 'mr-1-inside',
    ...
    zoneRadius: 90,
    yourBoat: {
      // Inside boat - closer to the mark (left position on starboard approach)
      startX: 520,
      startY: 420,
      endX: 430,
      endY: 200,
      ...
      resolutionEndX: 340,
      resolutionEndY: 140,
      rotate: 315,  // Starboard tack, sailing NW
      color: '#10B981',
      isUserBoat: true,
      label: 'Your Boat',
      labelOffsetX: -60,
    ...
    otherBoat: {
      // Outside boat - further from mark (right position)
      startX: 600,
      startY: 450,
      endX: 500,
      endY: 220,
      ...
      resolutionEndX: 480,
      resolutionEndY: 180,
      rotate: 315,  // Same heading - starboard tack
      color: '#3B82F6',
      isUserBoat: false,
      label: 'Other Boat',
      giveWayPath: 'M 545,320 Q 500,250 480,180',
      giveWayCtrl1: { x: -45, y: -70 },
      giveWayCtrl2: { x: -65, y: -140 },
      labelOffsetX: 60,
      labelOffsetY: 0,
    },
  ...
  // Scenario 2: You are outside boat, overlapped at zone - must give room
  {
    ...
    otherBoat: {
      // Inside boat - closer to mark (left position)
      startX: 520,
      startY: 420,
      endX: 430,
      endY: 200,
  ...
  // Scenario 3: You are clear ahead at zone - entitled to room
  {
    ...
    zoneRadius: 90,
    yourBoat: {
      // Lead boat - ahead and approaching mark
      startX: 540,
      startY: 380,
      endX: 450,
      endY: 200,
  ...
  // Scenario 4: You are clear astern at zone - must give room if they had position
  {
    ...
    yourBoat: {
      ...
      isUserBoat: true,
      label: 'Your Boat',
      giveWayPath: 'M 570,380 Q 520,320 500,250',
      giveWayCtrl1: { x: -50, y: -60 },
      giveWayCtrl2: { x: -70, y: -130 },
      labelOffsetX: 60,
      labelOffsetY: 0,
    },
    otherBoat: {
      // Lead boat - clear ahead
      startX: 540,
      startY: 380,
      endX: 450,
      endY: 200,
  ...
  // Boats on starboard tack approaching from right, but you try to sneak inside
  {
    ...
    zoneRadius: 90,
    yourBoat: {
      // Trying to sneak inside from astern - approaching from right on starboard
      startX: 580,
      startY: 450,
      endX: 450,
      endY: 240,
      ...
      isUserBoat: true,
      label: 'Your Boat',
      giveWayPath: 'M 510,330 Q 530,280 520,250',
      giveWayCtrl1: { x: 20, y: -50 },
      giveWayCtrl2: { x: 10, y: -80 },
      labelOffsetX: 60,
      labelOffsetY: 0,
    },
    otherBoat: {
      // Lead boat already at/near zone
      startX: 530,
      startY: 360,
      endX: 440,
      endY: 200,
  ...
  },
  {
    ...
    visualState: {
      boat1: {
        ...
        endX: 540,
        endY: 220,
        rotate: 315,  // Starboard tack, heading toward windward mark
        color: '#10B981',
        label: 'Clear Ahead',
      },
      boat2: {
        ...
        endX: 600,
        endY: 280,
        rotate: 315,  // Same heading as boat1, starboard tack
        color: '#EF4444',
        label: 'Clear Astern',
      },
      windArrow: { ...initialWind, opacity: 1, rotate: 0, x: 400, y: 60 },
      ...
      positionLabels: {
        clearAhead: { text: 'CLEAR AHEAD\n(No Obligation)', x: 620, y: 200 },
        clearAstern: { text: 'CLEAR ASTERN\n(No Rights)', x: 700, y: 280 },
      },
      roundingPath: {
        opacity: 1,
        properPath: {
          d: 'M 400,180 L 600,380',  // Starboard layline at ~45 degrees from mark
          label: 'STARBOARD LAYLINE',
        },
        improperPath: {
          d: 'M 400,180 L 200,380',  // Port layline at ~135 degrees from mark
          label: 'PORT LAYLINE',
        },
      },
      ruleText: {
