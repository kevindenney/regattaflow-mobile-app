-- ============================================================================
-- ADD 147 GLOBAL SAILING VENUES WITH COORDINATES
-- ============================================================================
-- Adds all major world sailing venues including Newport RI and Annapolis MD
-- Uses coordinates_lat and coordinates_lng columns for map display
-- VENUES ONLY - yacht clubs will be added separately after schema verification

-- ============================================================================
-- INSERT ALL 126 GLOBAL VENUES
-- ============================================================================

-- PART 1: WORLD CHAMPIONSHIP VENUES 2024-2026
...
-- PART 2: USA COMPREHENSIVE COVERAGE (40 venues)
  -- East Coast Premier
...
-- PART 3: CANADA COMPREHENSIVE COVERAGE (12 venues)
...
-- PART 4: NORTHERN EUROPE & SCANDINAVIA (18 venues)
  -- Sweden
...
-- PART 5: MEDITERRANEAN EXPANSION (25 venues)
  -- Spain
...
-- PART 6: CARIBBEAN EXPANSION (15 venues)
...
-- PART 7: PACIFIC & OCEANIA EXPANSION (8 venues)
