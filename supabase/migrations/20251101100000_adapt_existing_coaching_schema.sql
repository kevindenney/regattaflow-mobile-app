-- ============================================================================
-- Adapt Existing Coaching Schema
-- ============================================================================
-- This migration works with the existing coaching_sessions table
-- and adds missing columns, tables, views, and functions
--
-- Created: 2025-11-01
-- ============================================================================
...
-- Uses COALESCE to handle both sailor_id and student_id columns
