...
- **AI/ML**: Google AI (Gemini) for document parsing and strategy generation
...
2. **AI Parsing**: Google AI Gemini extraction
3. **Course Building**: 3D MapLibre visualization
4. **Strategy Generation**: Monte Carlo simulations
5. **Tactical Guidance**: Real-time race execution

### Key AI Features
- Sailing instruction parsing and course extraction
- Wind/tide/current forecasting integration
- Race strategy optimization with confidence scoring
- Equipment setup correlation with performance
- Real-time tactical decision recommendations
